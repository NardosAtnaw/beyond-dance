      ...
      <div class="sch-title">
        ...
        <div class="sch-img row-max-grid">
          ...
          <div class="desc row-max-grid">
            ...
            <div class="buttons">
              <button class="btn btn-thrid"><a href="">See Schedule</a> </button>
               <button  class="btn btn-secondary"><a href="./register">
...
<iframe 
src="https://youtu.be/hZsczpTkXj8">
</iframe>
    </div>
        <div class="single-video">
      
<iframe
src="https://www.youtube.com/watch?v=1G6uCoGnBRs">
</iframe>
    </div>
        <div class="single-video">
      
<iframe
src="https://www.youtube.com/watch?v=7bRxWXRofeM">
</iframe>
    </div>
   </div>
  </div>
...
<div class="contact-list">
  ...
  <div class="contact-info row-max-grid">
    ...
    <p class="row-grid">Africa Ave, Addis Ababa, Ethiopia
