        ...
        <div class="logo">
          <nuxt-link to="/">
            ...
            <div class="bg-container">
              ...
              <div class="bg-block">
                <img class="mid2" src="../assets/img/logo2.svg" alt="" />
              </div>
              <div class="bg-block">
              ...
              <div class="bg-block">
                <img src="../assets/img/logo5.svg" />
              </div>
              <div class="bg-block">
                <img src="../assets/img/logo6.svg" />
              </div>
            </div>
          </nuxt-link>
        </div>
          ...
          <nav role="navigation">
            <div id="menuToggle">
              ...
              <ul id="menu" class="ul-links1">
                ...
                <li><nuxt-link to="/program">Programs</nuxt-link></li>
                <li>
          ...
          <ul class="ul-links">
            ...
            <li>
              <nuxt-link to="/register"
                ><span class="box-form">Register Now</span>
              </nuxt-link>
            </li>
          </ul>
        </div>
...
export default {
  ...
  mounted() {
    ...
    (function () {
      ...
      s1.async = true;
      s1.src = "https://embed.tawk.to/632d5d1737898912e96ad5dd/1gdkj793v";
      s1.charset = "UTF-8";
